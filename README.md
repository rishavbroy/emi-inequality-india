...
- [`outputs/diagnostics/build/`](outputs/diagnostics/build/): short-lived build metadata and target warnings.
- [`outputs/diagnostics/public/`](outputs/diagnostics/public/): public-build diagnostics used by paper/report audits.
