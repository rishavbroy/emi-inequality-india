...
- [`data/metadata/`](data/metadata/): tracked source catalog, manifests, checksums, current crosswalk, and district-lineage-v2 adjudication ledgers; see [`data/metadata/README.md`](data/metadata/README.md).
- [`docs/DISTRICT_LINEAGE_V2.md`](docs/DISTRICT_LINEAGE_V2.md): durable data/methodology handoff and migration plan for rebuilding the pseudo-panel on Census 2001 districts.
