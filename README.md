...
A raw-data-less district analysis replication is available with `make replicate-processed`; full reconstruction still requires the source files documented in `REPLICATION.md`.
