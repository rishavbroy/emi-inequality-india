...
def path_tests(path):
    ...
    pipeline_test_map = {
        ...
        "R/pipeline/core_panel_targets.R": {
            "test-diagnostics.R",
            "test-iv-estimation.R",
            "test-measures.R",
            "test-prices-and-controls.R",
        },
        "R/pipeline/core_public_targets.R": {
            "test-diagnostics.R",
            "test-iv-estimation.R",
            "test-output-figures.R",
            "test-output-tables.R",
        ...
        "R/output/appendix_identification_exhibits.R": {
            "test-output-tables.R",
            "test-public-scripts.R",
        },
        "R/output/appendix_migration_exhibits.R": {
            "test-appendix-migration-exhibits.R",
            "test-output-tables.R",
            "test-public-scripts.R",
        },
    ...
    if path == "R/output/paper_new_tables.R" or path.startswith("R/output/appendix_"):
