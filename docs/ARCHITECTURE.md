...
Census 2011 HL-13 structural-durability counts reuse the shared count/geography path as follow-up-only measures. Ordinary Census-2001 H-04 is registered for acquisition but remains outside the reader because it counts census houses rather than households; longitudinal durability remains blocked on acquisition and raw inspection of the household-denominator H-04 Appendix (`PC01_H04a`) rather than being imputed from H-03 materials.
