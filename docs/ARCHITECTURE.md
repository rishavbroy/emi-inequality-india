...
Migration mechanism regressions remain in extended diagnostics. Harmonized D-02/D-03/D-04/D-07 outcomes are joined only after complete-parent reconstruction, then evaluated on one common support sample across registered outcomes and candidate scalar-IV designs. Reduced forms are estimated before any weak-IV 2SLS mechanism layer so post-treatment mechanism evidence cannot be mistaken for an automatically identified mediation effect.
