...
Census 2011 HL-13 structural-durability counts reuse the shared count/geography path as follow-up-only measures; longitudinal durability remains blocked on acquisition/inspection of the exact 2001 H-04 counterpart rather than being imputed from H-03 materials.
