...
Mechanism diagnostics use the preferred scalar linguistic-distance measure. Predetermined school-quality associations are reported separately for 2005-06 and 2006-07 with state fixed effects and state-clustered inference; 2007-08 is reserved as the reference year for the dynamic trajectories rather than mislabeled as pre-treatment balance. Dynamic trajectories use the same district+year and district+state×year specifications, Census-2001 district clustering, and 2007-08 reference year as the EMI event study. The summary reports omnibus tests for all distance×year terms and separate pre-2007-08 and post-2007-08 joint tests so a significant full-period test cannot be mistaken for evidence of post-baseline divergence when it is driven by pre-period differences. Later-only amenities such as electricity and computers are excluded from the common mechanism registry because they do not have a comparable 2007-08 baseline. DISE/UDISE publications likewise report single-teacher-school and girls'-toilet availability as school-system indicators.
