...
These household-capacity changes remain descriptive co-evolving development evidence. They are **not** preferred controls or identified mediation effects. A separate bounded paper-facing synthesis uses only four predeclared human-capital-capacity changes and ordinary OLS/reduced-form associations; it does not create another weak-IV outcome family.
