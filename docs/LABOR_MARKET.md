...
Realized F1 inspection finds 655 source district identities. The reviewed primary bridge resolves 614 districts and about 94.85% of sampled persons; the conservative deterministic bridge resolves 446 districts and about 68.17%. The shared four-outcome long-run estimator is activated for both variants under the unchanged denominator-specific 5-FSU/Kish-100 support rule. The next audit should compare realized target support and district estimates across these two reviewed variants before later PLFS waves are added.
