...
The shared four-outcome long-run labor estimator is now activated for both the preferred primary bridge and the conservative deterministic sensitivity under the unchanged denominator-specific support rule. The next labor gate is realized comparison of their support and district estimates; do not add later PLFS waves until that comparison is inspected.
