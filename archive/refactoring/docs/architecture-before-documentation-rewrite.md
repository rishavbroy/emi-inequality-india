> **Historical snapshot.** This is the pre-rewrite architecture/status document retained during the documentation reorganization. It is not authoritative for the active module boundaries; use [`../../../docs/ARCHITECTURE.md`](../../../docs/ARCHITECTURE.md).
