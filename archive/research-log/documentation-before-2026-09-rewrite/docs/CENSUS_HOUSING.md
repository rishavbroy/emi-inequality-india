...
These regressions use **changes**, not 2011 levels, so the estimand is local improvement in the measured housing/living-standard margin between 2001 and 2011. The bounded banking/durable rows used in the main synthesis are publication dependencies; the full family remains extended diagnostic evidence. None are controls in the preferred welfare equation or claims of identified mediation.
