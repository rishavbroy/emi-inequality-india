...
```
    ...
    1       rook 573       5.204188         3           1.670
    2      queen 573       5.232112         3           1.679
...
|:---|---:|---:|---:|---:|:---|:---|---:|:---|
| rook | 573 | 5.204 | 3 | 4 | NA | current_final_matched_panel_non_empty_geometry | 1.670 | some observations have no neighbours; |
...
\|current_final_matched_panel_non_empty_geometry \| 1.679\|some
...
|:---|---:|---:|---:|---:|:---|:---|---:|:---|---:|---:|---:|
| rook | 573 | 5.204 | 3 | 4 | NA | current_final_matched_panel_non_empty_geometry | 1.561 | some observations have no neighbours; |  |  |  |
...
\| 1.523\|some observations have no neighbours; if this seems
