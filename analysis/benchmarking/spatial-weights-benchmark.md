...
```
    ...
    1       rook 573       5.204188         3           1.369
    2      queen 573       5.232112         3           1.557
...
|:---|---:|---:|---:|---:|:---|:---|---:|:---|
| rook | 573 | 5.204 | 3 | 4 | NA | current_final_matched_panel_non_empty_geometry | 1.369 | some observations have no neighbours; |
...
\|current_final_matched_panel_non_empty_geometry \| 1.557\|some
...
|:---|---:|---:|---:|---:|:---|:---|---:|:---|---:|---:|---:|
| rook | 573 | 5.204 | 3 | 4 | NA | current_final_matched_panel_non_empty_geometry | 1.200 | some observations have no neighbours; |  |  |  |
...
\| 1.098\|some observations have no neighbours; if this seems
