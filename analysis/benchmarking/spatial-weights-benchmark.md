...
```
    ...
    1       rook 482       4.029046         0          11.414
    2      queen 482       4.041494         0          11.207
...
|:---|---:|---:|---:|:---|---:|:---|
| rook | 482 | 4.029 | 0 | current_final_matched_panel_non_empty_geometry | 11.414 | some observations have no neighbours; |
...
0\|current_final_matched_panel_non_empty_geometry \| 11.207\|some
...
|:---|---:|---:|---:|:---|---:|:---|---:|---:|---:|
| rook | 482 | 4.029 | 0 | current_final_matched_panel_non_empty_geometry | 11.532 | some observations have no neighbours; |  |  |  |
...
11.422\|some observations have no neighbours; if this seems unexpected,
