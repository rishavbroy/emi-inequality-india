...
```
    ...
    1       rook 573       5.204188         3           1.117
    2      queen 573       5.232112         3           1.089
...
|:---|---:|---:|---:|---:|:---|:---|---:|:---|
| rook | 573 | 5.204 | 3 | 4 | NA | current_final_matched_panel_non_empty_geometry | 1.117 | some observations have no neighbours; |
...
\|current_final_matched_panel_non_empty_geometry \| 1.089\|some
...
|:---|---:|---:|---:|---:|:---|:---|---:|:---|---:|---:|---:|
| rook | 573 | 5.204 | 3 | 4 | NA | current_final_matched_panel_non_empty_geometry | 1.210 | some observations have no neighbours; |  |  |  |
...
\| 1.129\|some observations have no neighbours; if this seems
