...
48.806 seconds. This creates a documented deviation from the legacy
...
|:---|---:|---:|---:|---:|---:|:---|
| avg_slopes_centered_default | 200 | 114961 | 10 | 2299220 | 0.973 | estimated_legacy_vcov |
| avg_slopes_fdforward | 200 | 114961 | 10 | 2299220 | 0.919 | estimated_legacy_vcov |
| avg_slopes_centered_default | 2000 | 114961 | 10 | 2299220 | 4.939 | estimated_legacy_vcov |
| avg_slopes_fdforward | 2000 | 114961 | 10 | 2299220 | 4.761 | estimated_legacy_vcov |
| avg_slopes_centered_default | 20000 | 114961 | 10 | 2299220 | 48.806 | estimated_legacy_vcov |
| avg_slopes_fdforward | 20000 | 114961 | 10 | 2299220 | 46.277 | estimated_legacy_vcov |
...
```
    ...
    1 avg_slopes_centered_default         200           0.973 estimated_legacy_vcov
    2        avg_slopes_fdforward         200           0.919 estimated_legacy_vcov
    3 avg_slopes_centered_default        2000           4.939 estimated_legacy_vcov
    4        avg_slopes_fdforward        2000           4.761 estimated_legacy_vcov
    5 avg_slopes_centered_default       20000          48.806 estimated_legacy_vcov
    6        avg_slopes_fdforward       20000          46.277 estimated_legacy_vcov
      reason
    1     NA
    2     NA
    3     NA
...
|:---|---:|---:|:---|:---|:---|
| avg_slopes_fdforward | 200 | 0.919 | estimated_legacy_vcov | NA | NA |
| avg_slopes_fdforward | 2000 | 4.761 | estimated_legacy_vcov | NA | NA |
| avg_slopes_fdforward | 20000 | 46.277 | estimated_legacy_vcov | NA | NA |
