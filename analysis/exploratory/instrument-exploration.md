...
The legacy IV-construction chunk included exploratory checks of the 2001
instrument, district joins, and potential instrument-strength plots that
were not used as final paper outputs. The current note reads the
parity-audit diagnostics produced by the active pipeline instead of
copying exploratory values from deleted code.
