...
analysis_target_output_dir <- function(target) {
  dirs <- c(
    ...
    diag_ext_district_lineage = "outputs/diagnostics/extended/district_lineage",
    diag_ext_legacy_crosswalk_comparison = "outputs/diagnostics/extended/district_lineage",
