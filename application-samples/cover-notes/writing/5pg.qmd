...
4. **Main result**: Strong first-stage ($F=39.2$), null second-stage estimate ($0.2$ pp, $p=0.78$). <u>Estimates are provisional</u> pending district matching that enables state FEs.
...
27. **Second-stage 2SLS results**; recall $F=39.2$ in first stage.
