...
labor_mechanism_registry <- function(wave_id = c("nss66", "plfs_2017_18")) {
  ...
  data.frame(
    ...
    construct_id = paste(wave_id, c("labor_force_participation_age15plus", "employment_rate_age15plus"), sep = "__"),
    label = c("Labor-force participation rate, age 15+", "Employment rate, age 15+"),
    unit = rep("share", 2L),
