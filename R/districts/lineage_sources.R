...
district_lineage_input_specs <- function(paths = build_paths()) {
  ...
  rows <- list(
    ...
    spec("kumar_somanathan_1991_2001", "data/raw/district_changes/District Carve-Outs and Renamings 1961-2001.csv", "carveout_csv", TRUE, "historical_geography_benchmark"),
    ...
    spec("shrug_pc91r", "data/raw/shrug/shrug-pc-keys-csv/pc91r_shrid_key.csv", "shrug_locality_csv", TRUE, "historical_language_geography_weight"),
    spec("shrug_pc91u", "data/raw/shrug/shrug-pc-keys-csv/pc91u_shrid_key.csv", "shrug_locality_csv", TRUE, "historical_language_geography_weight"),
    spec("shrug_pc91dist", "data/raw/shrug/shrug-pc-keys-csv/shrid_pc91dist_key.csv", "shrug_district_csv", TRUE, "historical_language_geography_membership"),
    ...
    spec("shrug_pca91_zip", "data/raw/shrug/census_1991/shrug-pca91-csv.zip", "inventory_only", FALSE, "historical_baseline_attributes"),
    spec("shrug_td91_zip", "data/raw/shrug/census_1991/shrug-td91-csv.zip", "inventory_only", FALSE, "historical_baseline_attributes"),
    spec("shrug_vd91_zip", "data/raw/shrug/census_1991/shrug-vd91-csv.zip", "inventory_only", FALSE, "historical_baseline_attributes"),
...
read_lineage_source <- function(path, reader, source_id = NA_character_) {
  switch(
    ...
    carveout_csv = read_district_carveouts(path),
