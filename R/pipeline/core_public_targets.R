...
core_public_target_definitions <- function() {
  list(
    ...
    tar_target(
      appendix_data_construction_figures,
      make_appendix_data_construction_figures(
    ...
    tar_target(
      ...
      save_appendix_data_construction_figures(appendix_data_construction_figures, cfg),
      format = "file"
    ),
    tar_target(
    ...
    tar_target(
      ...
      make_appendix_selection_exhibits(
        ame_results, selection_model, selection_missingness_diagnostics
      )
    ),
    tar_target(
