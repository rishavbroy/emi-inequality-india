...
build_report_values <- function(ame_results, first_stage_tests, iv_models, selection_data, district_panel, diag_spatial_autocorrelation = NULL, cfg = list()) {
  ...
  values$partial_f <- value_or_status(first_available_number(first_stage_tests, c("legacy_model_f", "partial_f", "statistic", "f_stat", "F")), unavailable_first_stage)
  values$partial_p <- value_or_status(first_available_number(first_stage_tests, c("legacy_model_p", "partial_p", "p.value", "p_value", "p")), unavailable_first_stage)
