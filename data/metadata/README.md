...
Census housing diagnostics activate 2011 HL-13 for follow-up structural durability. Ordinary 2001 H-04 is registered in the acquisition manifest but remains acquisition-only because it counts census houses, not households. The H-04 Appendix (`PC01_H04a`) is the candidate household-denominator counterpart and must be acquired and inspected before durability changes are constructed.
