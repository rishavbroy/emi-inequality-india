...
- Census migration acquisition uses the year-specific download manifests; D-02/D-03/D-04/D-07 district semantics, cross-table accounting checks, the 2001 D-03 granularity limitation, and the distinction between 2001 validity evidence and 2011 mechanisms are documented in `docs/CENSUS_MIGRATION.md`.
- Census worker-structure acquisition uses the same 2011 manifest; B-04/B-06 industry accounting, B-25A/B occupational universes, and deterministic 2011-to-2001 count pooling are documented in `docs/CENSUS_WORKERS.md`.
