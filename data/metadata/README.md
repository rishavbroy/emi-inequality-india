...
- Census migration acquisition uses the year-specific download manifests; active district-level semantics and the 2001 D-03 granularity limitation are documented in `docs/CENSUS_MIGRATION.md`.
