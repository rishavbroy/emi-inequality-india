...
project_packages <- function() {
  c("tidyverse", "haven", "readxl", "sf", "spdep", "survey", "marginaleffects", "ivreg", "sandwich", "lmtest", "modelsummary", "kableExtra", "stringdist", "fuzzyjoin", "magick", "yaml", "targets", "tarchetypes", "testthat", "broom")
}
