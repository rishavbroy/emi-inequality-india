...
\title{Escaping Inequality in India: \\ The Role of English-Medium Instruction \\ \large{(Selected Excerpts)}}
...
\maketitle
\vspace{-6mm}
\noindent What follows are excerpts from my 49-page independent research paper, "Escaping Inequality in India: The Role of English-Medium Instruction." The paper's key points are below.
...
\noindent The next five pages include the following details: 
...
\item[27:] \textbf{Second-stage 2SLS results}; recall $F=39.2$ in first stage.
\item[28:] \textbf{Interpretation of 2SLS}, small \& noisy estimate, `bad control,' spillover attenuation. 
\item[33:] \textbf{District harmonization} assumptions, algorithm, and demonstration.
