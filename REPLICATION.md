...
A separate candidate control-strategy family compares region/state geography-only specifications, compact-2001 adjustment, and compact-2001 adjustment without human capital using the preferred Shastry scalar instrument. This is distinct from the finite control-parameterization family (secondary-plus versus literacy; compact versus decomposed economic structure) and from the 1991-vintage adjustment robustness. The separation keeps causal control philosophy, proxy choice, response definition, and instrument definition from being automatically crossed into an uninterpretable specification search.
