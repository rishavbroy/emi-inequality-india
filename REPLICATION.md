...
The 2001 acquisition manifest registers H-04 Appendix (`PC01_H04a`) workbooks under `data/raw/census_2001/housing/H04A/`. They remain acquisition-only until the raw sheets are inspected, their structural categories are validated, and their reported household universe is reconciled to an established Census-2001 housing denominator. Census 2011 HL-13 therefore remains follow-up-only until that source-level validation is complete.
