...
legacy-public-diagnostics:
	python3 scripts/audit_legacy_parity.py --write-diagnostics-only

analysis-notes:
	$(MAKE) public-diagnostics
	$(MAKE) extended-diagnostics
	$(MAKE) benchmarking
	$(MAKE) legacy-public-diagnostics
