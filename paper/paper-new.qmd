...
Summary statistics for all variables in this model, including the controls $k$ in the vector $X_{kd}$, are provided in @tbl-sum-tbl-iv. Maps of these variables, created using 2001 boundaries, are presented in @fig-map1-fig and @fig-map2-fig.

![(Clockwise from top left) EMI exposure, consumption growth, pucca (permanent) housing, and household heads with secondary education or more. Data from the 64th round of the NSS 2007-08, "Participation and Expenditure in Education" and "Household Consumer Expenditure."](../outputs/figures/main/collage_main_maps.pdf){#fig-map1-fig fig-pos="H" width="100%"}
...
render_public_table("../outputs/tables/main/sum_tbl_iv.tex", "sum_tbl_iv")
```
