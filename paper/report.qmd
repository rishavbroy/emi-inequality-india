...
The second-stage EMIE estimate is `r report_value("iv_emie_estimate_report")` with $p=$ `r report_value("iv_emie_p")`. Because the instrument contributes almost no conditional first-stage variation, this estimate should not be interpreted as a credible causal effect. The appropriate conclusion is not that EMI has no effect, but that this instrument cannot distinguish such an effect under the preferred control and fixed-effect specification.
