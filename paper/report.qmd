...
\end{aligned}
$$ {#eq-iv-eq}
Summary statistics for all of the variables in this model, including the controls $k$ in the vector $X_{kd}$, are provided in @tbl-sum-tbl-iv. The district map figures below use the validated district-panel geometry produced by the active tracker and are included here to preserve the legacy paper's map figures.
