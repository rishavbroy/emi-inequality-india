...
knitr::kable(read_public_table("../outputs/tables/main/sum_tbl_iv.csv"),
  digits = 3,
...
knitr::kable(read_public_table("../outputs/tables/main/sum_tbl_probit_quant.csv"),
  digits = 3,
  booktabs = knitr::is_latex_output(),
  longtable = knitr::is_latex_output()
)
...
knitr::kable(read_public_table("../outputs/tables/main/sum_tbl_probit_cat.csv"),
  digits = 3,
  booktabs = knitr::is_latex_output(),
  longtable = knitr::is_latex_output()
)
...
knitr::kable(read_public_table("../outputs/tables/main/probit_mfx.csv"),
  digits = 3,
  booktabs = knitr::is_latex_output(),
  longtable = knitr::is_latex_output()
)
...
\end{aligned}
$$ {#eq-iv-eq}
Summary statistics for all of the variables in this model, including the controls $k$ in the vector $X_{kd}$, are provided in @tbl-sum-tbl-iv. To best reflect how districts merged and split over time, our current data harmonization method uses many-to-many matching from 2001 to 2007-08 to 2017-18 to 2019-20, the years our shapefiles data was collected [@bhatiaMergingUpdatedDistrictlevel2020]. Issues with and improvements to this method are discussed in @sec-distma-spa.

![From left to right: linguistic distance from Hindi and regions of India. District-level data, from the 2001 Census of India.](../outputs/figures/main/collage_iv_region_maps.pdf){#fig-map2-fig}
...
knitr::kable(read_public_table("../outputs/tables/main/cons_iv.csv"),
  digits = 3,
  booktabs = knitr::is_latex_output(),
  longtable = knitr::is_latex_output()
)
...
knitr::kable(read_public_table("../outputs/tables/main/fs_cons.csv"),
  digits = 3,
  booktabs = knitr::is_latex_output(),
  longtable = knitr::is_latex_output()
)
...
![Number of 2001 districts which absorbed a percentage of a 1991 district's population via name change, clean merger, carve-out, or border shift. Data from Kumar \& Somanathan (2016).](../outputs/figures/main/district_carveouts_shifts.pdf){#fig-districtcarveoutsshifts-fig}
